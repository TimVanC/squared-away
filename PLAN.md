...
- [x] 3. Grid with date nav, double tap complete, midnight reset (PRD 4.2, 4.3)
...
- [x] 8. Chat UI with attachments and dictation (PRD 4.10)
- [x] 9. AI tools, streaming, action cards with undo (PRD 4.10)
- [x] 10. PWA manifest, service worker, push notifications and scheduler (PRD 4.11)
- [x] 11. Deploy to Vercel, add to iPhone home screen (PRD 9.11)

Done when: upload a bar schedule, say "plan my week", and every day's tiles are retimed for close, open, prep, and off days.
